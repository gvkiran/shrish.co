...
<section class="seo-product-links" aria-label="Browse all products">
  <style>
    .seo-product-links { background: var(--cream, #FDF6EC); border-top: 1px solid rgba(200,121,26,.12); padding: 40px 24px; }
    .seo-product-links-inner { max-width: 1240px; margin: 0 auto; }
    .seo-product-links h2 { font-family: var(--font-display, serif); color: var(--dark, #1A1208); font-size: 26px; margin-bottom: 18px; }
    .seo-links-columns { display: grid; grid-template-columns: repeat(auto-fit, minmax(220px, 1fr)); gap: 22px; }
    .seo-links-group h3 { color: var(--saffron, #C8791A); font-size: 15px; margin-bottom: 8px; text-transform: uppercase; letter-spacing: .06em; }
    .seo-links-group ul { list-style: none; margin: 0; padding: 0; }
    .seo-links-group li { margin: 0 0 6px; }
    .seo-links-group a { color: var(--text, #3c2f1e); font-size: 14px; text-decoration: none; }
    .seo-links-group a:hover { color: var(--saffron, #C8791A); }
    .seo-links-directory { display: inline-block; margin-top: 16px; color: var(--saffron, #C8791A); font-weight: 700; font-size: 14px; }
  </style>
